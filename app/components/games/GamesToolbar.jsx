...
import { gameFilters } from "./gameConstants";

export default function GamesToolbar({ onAddGame }) {
  return (
    <>
      <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div>
          <h2 className="text-base leading-6 text-white">Games</h2>
          <p className="text-sm leading-5 text-white/40">Manage catalog entries, media, publishing status, and reviews.</p>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <button className="inline-flex h-9 items-center justify-center gap-2 rounded-lg bg-[#8e51ff] px-4 text-sm font-medium text-white transition hover:bg-[#9b66ff]" type="button" onClick={onAddGame}>
